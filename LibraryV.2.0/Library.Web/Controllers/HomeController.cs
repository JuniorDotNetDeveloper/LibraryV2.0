...
namespace Library.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        //            var isIt = _ratingLogRepository.Collection.Where(v => v.SectionId == sectionId &&
        //                v.User.Email.Equals(User.Identity.Name, StringComparison.CurrentCultureIgnoreCase) && v.VoteForId == autoId).FirstOrDefault();
        //            if (isIt != null)
        //            {
