...
namespace Domain.Model.Models
{
    public class Book : Entity 
    {
        ...
        public virtual string CoverLink { get; set; }
        ...
        public Book(string bookName, DateTime publicationDate, BookCategory category, IList<Author> authors, string coverLink = @"~/Img/Book/defaultBook.jpg", string description = null)   
        {
        ...
        private void ValidateInput( string bookName, DateTime publicationDate, BookCategory category, string description, IList<Author> authors = null)
        {
            ...
            if (publicationDate > DateTime.Now)
                throw new ArgumentNullException($"{nameof(publicationDate)} is invalid");
